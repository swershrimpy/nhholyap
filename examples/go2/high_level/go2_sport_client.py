...
def high_state_handler(msg:SportModeState_):
    global position
...
if __name__ == "__main__":
    ...
    state_subscriber = ChannelSubscriber("rt/sportmodestate", SportModeState_)
    state_subscriber.Init(high_state_handler)
