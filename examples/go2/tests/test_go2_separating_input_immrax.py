"""
Tests for go2_separating_input_immrax.py
"""
import os
import sys
...
# File is at examples/go2/tests/<name>.py
#   parents[1] = examples/go2/
#   parents[2] = examples/
_EXAMPLES_DIR = Path(__file__).resolve().parents[2]
_GO2_DIR      = Path(__file__).resolve().parents[1]
for _d in (_EXAMPLES_DIR, _GO2_DIR):
