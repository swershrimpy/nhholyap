...
ONE unicycle config (single_step/config_idx=62), run back-to-back in one Robotarium session.
...
X0_WIDTH = 0.05000000074505806   # half-width car_separating_input.py's icentpert()
