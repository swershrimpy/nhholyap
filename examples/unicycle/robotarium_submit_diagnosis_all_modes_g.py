...
ONE unicycle config (single_step/config_idx=10), run back-to-back in one Robotarium session.
...
Config selection: method=single_step, config_idx=10 from
...
satisfies real Robotarium hardware velocity limits (max|v|=0.0522 m/s,
max|omega|=0.7574 rad/s, vs. limits 0.2 m/s / 3.6364 rad/s).
...
# "Regenerating the embedded constants". method=single_step, config_idx=10.
# ══════════════════════════════════════════════════════════════════════════
U_OPT = np.array([
    [-0.05223721265792847, 0.7573860883712769],
    [-0.05223721265792847, 0.7573860883712769],
    [-0.05223721265792847, 0.7573860883712769],
    [-0.05223721265792847, 0.7573860883712769],
    [-0.05223721265792847, 0.7573860883712769],
...
TUBE_LO = {
    "Nominal": np.array([
    [0.004193631466478109, 0.02353205531835556],
    [-0.018708741292357445, 0.008226278237998486],
    [-0.03546709194779396, -0.013748454861342907],
    [-0.043706730008125305, -0.03927826136350632],
    [-0.04226009547710419, -0.06522827595472336],
    [-0.03133218735456467, -0.0887795239686966],
    [-0.01247149333357811, -0.10662204027175903],
    [0.011649373918771744, -0.11622748523950577],
    [0.03729049488902092, -0.11623473465442657],
    [0.05984220653772354, -0.10664279758930206],
    ]),
    "Actuator Fault": np.array([
    [0.003881387412548065, 0.025822220370173454],
    [-0.022237222641706467, 0.016873853281140327],
    [-0.04835580661892891, 0.0034747628960758448],
    [-0.07447437942028046, -0.013896087184548378],
    [-0.1005929484963417, -0.03461778163909912],
    [-0.12671153247356415, -0.057949624955654144],
    [-0.15283028781414032, -0.08305761218070984],
    [-0.1789490431547165, -0.10904428362846375],
    [-0.20506779849529266, -0.13516291975975037],
    [-0.23118655383586884, -0.16128167510032654],
    ]),
    "Sensor Fault": np.array([
    [0.20398394763469696, 0.222355455160141],
    [0.18222670257091522, 0.20781496167182922],
    [0.1663062572479248, 0.18693897128105164],
    [0.15847861766815186, 0.16268566250801086],
    [0.15985292196273804, 0.13803313672542572],
    [0.17023442685604095, 0.1156594529747963],
    [0.18815208971500397, 0.09870906919240952],
    [0.21106690168380737, 0.08958389610052109],
    [0.23542597889900208, 0.08957700431346893],
    [0.25685009360313416, 0.09868934750556946],
    ]),
}
TUBE_HI = {
    "Nominal": np.array([
    [0.14485548436641693, 0.167104110121727],
    [0.12388374656438828, 0.1548745483160019],
    [0.11005653440952301, 0.13504429161548615],
    [0.10533317923545837, 0.11042340099811554],
    [0.11038298904895782, 0.08497564494609833],
    [0.1244904026389122, 0.06317972391843796],
    [0.14565639197826385, 0.048143647611141205],
    [0.17088164389133453, 0.04199806973338127],
    [0.19692152738571167, 0.04561382532119751],
    [0.2210477739572525, 0.05847855657339096],
    ]),
    "Actuator Fault": np.array([
    [0.14425717294216156, 0.17182688415050507],
    [0.11976071447134018, 0.1736537665128708],
    [0.09738630801439285, 0.1754806488752365],
    [0.07793372869491577, 0.17730753123760223],
    [0.062098316848278046, 0.17913441359996796],
    [0.050446078181266785, 0.18096129596233368],
    [0.043393537402153015, 0.1827881783246994],
    [0.04119277745485306, 0.18461506068706512],
    [0.04392247647047043, 0.18644194304943085],
    [0.051485054194927216, 0.18826882541179657],
    ]),
    "Sensor Fault": np.array([
    [0.33761271834373474, 0.3587489128112793],
    [0.31768956780433655, 0.34713083505630493],
    [0.30455371737480164, 0.3282920718193054],
    [0.3000665307044983, 0.30490222573280334],
    [0.304863840341568, 0.2807268500328064],
    [0.3182658851146698, 0.26002073287963867],
    [0.3383735716342926, 0.24573646485805511],
    [0.36233755946159363, 0.2398981750011444],
    [0.3870754539966583, 0.2433331310749054],
    [0.4099953770637512, 0.2555546164512634],
    ]),
}
