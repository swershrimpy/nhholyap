...
ONE unicycle config (multistep_refined/config_idx=13), run back-to-back in one Robotarium session.
...
Config selection: method=multistep_refined, config_idx=13 from
...
satisfies real Robotarium hardware velocity limits (max|v|=0.0853 m/s,
max|omega|=1.0000 rad/s, vs. limits 0.2 m/s / 3.6364 rad/s).
...
# "Regenerating the embedded constants". method=multistep_refined, config_idx=13.
# ══════════════════════════════════════════════════════════════════════════
U_OPT = np.array([
    [-0.013192599639296532, 1.0],
    [-0.023602675646543503, 1.0],
    [-0.03402329236268997, 1.0],
    [-0.03887471556663513, 1.0],
    [-0.033410560339689255, 1.0],
    [-0.043799690902233124, 1.0],
    [-0.0726301297545433, 0.9998604655265808],
    [-0.08457619696855545, 0.9996132254600525],
    [-0.08527171611785889, 0.9994809627532959],
    [-0.0817175954580307, 1.0],
...
TUBE_LO = {
    "Nominal": np.array([
    [0.013553890399634838, 0.01794653944671154],
    [0.004327583126723766, 0.00940750166773796],
    [-0.0023954149801284075, -0.006901080254465342],
    [-0.000681800302118063, -0.026087237522006035],
    [0.008505045436322689, -0.0398317389190197],
    [0.02771272137761116, -0.04987041652202606],
    [0.06294843554496765, -0.049210239201784134],
    [0.09553609043359756, -0.02847971022129059],
    [0.1116863265633583, 0.0074305166490375996],
    [0.10736467689275742, 0.04731098562479019],
    ]),
    "Actuator Fault": np.array([
    [0.013408517464995384, 0.018464455381035805],
    [0.0018105285707861185, 0.01221330277621746],
    [-0.014125964604318142, -0.000905216729734093],
    [-0.03088509850203991, -0.01901814341545105],
    [-0.04360262304544449, -0.03565783426165581],
    [-0.0575551874935627, -0.05755769833922386],
    [-0.07547583431005478, -0.09387276321649551],
    [-0.08963409811258316, -0.13616077601909637],
    [-0.0967092365026474, -0.17879672348499298],
    [-0.0963817834854126, -0.21962155401706696],
    ]),
    "Sensor Fault": np.array([
    [0.21287620067596436, 0.21704921126365662],
    [0.20411120355129242, 0.2089371234178543],
    [0.1977243572473526, 0.19344398379325867],
    [0.19935229420661926, 0.17521712183952332],
    [0.20807980000972748, 0.16215986013412476],
    [0.2263270914554596, 0.15262311697006226],
    [0.2598010301589966, 0.15325027704238892],
    [0.29075929522514343, 0.17294427752494812],
    [0.3061020076274872, 0.20705899596214294],
    [0.3019964396953583, 0.2449454367160797],
    ]),
}
TUBE_HI = {
    "Nominal": np.array([
    [0.17380349338054657, 0.17895998060703278],
    [0.16583581268787384, 0.17179937660694122],
    [0.1616576910018921, 0.1563647836446762],
    [0.16640183329582214, 0.13774339854717255],
    [0.17766112089157104, 0.12563809752464294],
    [0.198222815990448, 0.11878775805234909],
    [0.23430083692073822, 0.1251642107963562],
    [0.2706556022167206, 0.151421919465065],
    [0.29280999302864075, 0.190403014421463],
    [0.29494866728782654, 0.23111842572689056],
    ]),
    "Actuator Fault": np.array([
    [0.17361468076705933, 0.17997364699840546],
    [0.16366609930992126, 0.17787514626979828],
    [0.15295319259166718, 0.17198552191257477],
    [0.14613965153694153, 0.16218852996826172],
    [0.145561084151268, 0.1513894498348236],
    [0.15180020034313202, 0.13454580307006836],
    [0.17266596853733063, 0.1054433211684227],
    [0.20666879415512085, 0.08061499893665314],
    [0.24714785814285278, 0.06783372908830643],
    [0.2879451513290405, 0.06860942393541336],
    ]),
    "Sensor Fault": np.array([
    [0.3651133179664612, 0.37001198530197144],
    [0.3575440049171448, 0.36320942640304565],
    [0.35357481241226196, 0.34854656457901],
    [0.35808175802230835, 0.33085623383522034],
    [0.3687780499458313, 0.31935620307922363],
    [0.3883116841316223, 0.31284838914871216],
    [0.42258578538894653, 0.3189060091972351],
    [0.457122802734375, 0.3438508212566376],
    [0.4781695008277893, 0.3808828592300415],
    [0.48020124435424805, 0.41956251859664917],
    ]),
}
