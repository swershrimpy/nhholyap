...
ONE unicycle config (single_step/config_idx=40), run back-to-back in one Robotarium session.
...
Config selection: method=single_step, config_idx=40 from
success_rate_data_early_stop_single_step.npz -- chosen over the other 9
...
nearest edge: +0.057 m -- among the best in this family (only
multistep_unrefined/13 and multistep_refined/13, both already deployed as
_j.py/_c.py, do slightly better at the same x0_width).
x0_width=0.08 is the practical ceiling for this project's config sweep: no
hardware-feasible, successful config anywhere in the sweep has x0_width
>0.08 (success rate collapses above it -- see PLAN.md/commit history).
u_opt satisfies real Robotarium hardware velocity limits (max|v|=0.1388 m/s,
max|omega|=0.9281 rad/s, vs. limits 0.2 m/s / 3.6364 rad/s).
...
# "Regenerating the embedded constants". method=single_step, config_idx=40.
# ══════════════════════════════════════════════════════════════════════════
U_OPT = np.array([
    [0.13880358636379242, 0.9281212091445923],
    [0.13880358636379242, 0.9281212091445923],
    [0.13880358636379242, 0.9281212091445923],
    [0.13880358636379242, 0.9281212091445923],
    [0.13880358636379242, 0.9281212091445923],
...
X0_WIDTH = 0.07999999821186066   # half-width car_separating_input.py's icentpert()
...
TUBE_LO = {
    "Nominal": np.array([
    [0.43821677565574646, -0.317423939704895],
    [0.42482078075408936, -0.25011980533599854],
    [0.3826456069946289, -0.19578592479228973],
    [0.3206119239330292, -0.1660749614238739],
    [0.2514731287956238, -0.1672711819410324],
    [0.18621458113193512, -0.1991216093301773],
    [0.13758398592472076, -0.25488945841789246],
    [0.11586736887693405, -0.322787880897522],
    [0.1256580501794815, -0.39088675379753113],
    [0.16488522291183472, -0.4473859369754791],
    ]),
    "Actuator Fault": np.array([
    [0.4456479251384735, -0.3247837424278259],
    [0.45581746101379395, -0.26956748962402344],
    [0.4499637484550476, -0.21435123682022095],
    [0.428400456905365, -0.15913498401641846],
    [0.3922833800315857, -0.10393442213535309],
    [0.3435482680797577, -0.054741378873586655],
    [0.2848069965839386, -0.01807338558137417],
    [0.2192080318927765, 0.004104269202798605],
    [0.15026669204235077, 0.010602951049804688],
    [0.08086490631103516, 0.001074355561286211],
    ]),
    "Sensor Fault": np.array([
    [0.616305947303772, -0.10155273973941803],
    [0.6035797595977783, -0.03761380910873413],
    [0.5635133385658264, 0.014003381133079529],
    [0.5045813322067261, 0.04222878813743591],
    [0.4388994574546814, 0.04109238088130951],
    [0.37690383195877075, 0.010834470391273499],
    [0.33070480823516846, -0.042144984006881714],
    [0.31007400155067444, -0.10664848983287811],
    [0.3193751573562622, -0.1713424175977707],
    [0.3566409647464752, -0.22501663863658905],
    ]),
}
TUBE_HI = {
    "Nominal": np.array([
    [0.6085509657859802, -0.15367452800273895],
    [0.6060744524002075, -0.08475158363580704],
    [0.5730942487716675, -0.0243923868983984],
    [0.5165863633155823, 0.01482213381677866],
    [0.4488450884819031, 0.024597620591521263],
    [0.38788214325904846, 0.0028664327692240477],
    [0.3476221561431885, -0.04577501118183136],
    [0.3365804851055145, -0.111038438975811],
    [0.3570926785469055, -0.17669035494327545],
    [0.40482014417648315, -0.2262183427810669],
    ]),
    "Actuator Fault": np.array([
    [0.62204509973526, -0.15567846596240997],
    [0.6640902161598206, -0.08718283474445343],
    [0.7061353325843811, -0.017782554030418396],
    [0.7481804490089417, 0.051619235426187515],
    [0.7902255654335022, 0.12102102488279343],
    [0.8322706818580627, 0.19042281806468964],
    [0.8743157982826233, 0.25982466340065],
    [0.9163609147071838, 0.3292268216609955],
    [0.9584060311317444, 0.39862897992134094],
    [1.0004510879516602, 0.4680311381816864],
    ]),
    "Sensor Fault": np.array([
    [0.7781233787536621, 0.054009199142456055],
    [0.7757707238197327, 0.1194859966635704],
    [0.7444395422935486, 0.17682723701000214],
    [0.6907570362091064, 0.2140810340642929],
    [0.6264028549194336, 0.22336773574352264],
    [0.5684880614280701, 0.20272311568260193],
    [0.530241072177887, 0.1565137505531311],
    [0.5197514891624451, 0.09451349079608917],
    [0.5392380356788635, 0.032144173979759216],
    [0.5845791101455688, -0.014907419681549072],
    ]),
}
