...
ONE unicycle config (single_step/config_idx=12), run back-to-back in one Robotarium session.
...
Config selection: method=single_step, config_idx=12 from
...
satisfies real Robotarium hardware velocity limits (max|v|=0.0735 m/s,
max|omega|=0.6176 rad/s, vs. limits 0.2 m/s / 3.6364 rad/s).
...
# "Regenerating the embedded constants". method=single_step, config_idx=12.
# ══════════════════════════════════════════════════════════════════════════
U_OPT = np.array([
    [-0.07351235300302505, 0.6175685524940491],
    [-0.07351235300302505, 0.6175685524940491],
    [-0.07351235300302505, 0.6175685524940491],
    [-0.07351235300302505, 0.6175685524940491],
    [-0.07351235300302505, 0.6175685524940491],
...
TUBE_LO = {
    "Nominal": np.array([
    [-0.01653803139925003, 0.011717213317751884],
    [-0.05057753622531891, -0.007011323235929012],
    [-0.07891125977039337, -0.03441403806209564],
    [-0.09885901212692261, -0.06789883226156235],
    [-0.10853391140699387, -0.10430029779672623],
    [-0.10702073574066162, -0.1409081220626831],
    [-0.09446264058351517, -0.17529746890068054],
    [-0.07204761356115341, -0.204244002699852],
    [-0.041895922273397446, -0.22500959038734436],
    [-0.0068596466444432735, -0.23562997579574585],
    ]),
    "Actuator Fault": np.array([
    [-0.016756175085902214, 0.014363566413521767],
    [-0.0535123273730278, 0.0032143457792699337],
    [-0.09026846289634705, -0.013182424940168858],
    [-0.1270246058702469, -0.0344366729259491],
    [-0.16378092765808105, -0.06004276126623154],
    [-0.20053724944591522, -0.0893915444612503],
    [-0.2372935712337494, -0.12178477644920349],
    [-0.27404963970184326, -0.15645185112953186],
    [-0.3108055889606476, -0.19256804883480072],
    [-0.3475615382194519, -0.22927924990653992],
    ]),
    "Sensor Fault": np.array([
    [0.1842888742685318, 0.21113134920597076],
    [0.15195134282112122, 0.1933392435312271],
    [0.12503430247306824, 0.16730666160583496],
    [0.106083944439888, 0.1354961097240448],
    [0.09689278900623322, 0.10091472417116165],
    [0.0983303040266037, 0.06613728404045105],
    [0.1102604940533638, 0.03346741199493408],
    [0.1315547674894333, 0.005968198180198669],
    [0.1601988822221756, -0.013759106397628784],
    [0.19348333775997162, -0.02384847402572632],
    ]),
}
TUBE_HI = {
    "Nominal": np.array([
    [0.14433874189853668, 0.17750447988510132],
    [0.11288124322891235, 0.1640269160270691],
    [0.0886031910777092, 0.14084215462207794],
    [0.07380111515522003, 0.11014332622289658],
    [0.06987520307302475, 0.07483427226543427],
    [0.07719682157039642, 0.038973547518253326],
    [0.09507333487272263, 0.007024160586297512],
    [0.12181375175714493, -0.0179815124720335],
    [0.15488865971565247, -0.03367816284298897],
    [0.1911696046590805, -0.03858102485537529],
    ]),
    "Actuator Fault": np.array([
    [0.1437154859304428, 0.1829373985528946],
    [0.108729287981987, 0.1858747899532318],
    [0.07587376236915588, 0.18881218135356903],
    [0.04593054577708244, 0.19174957275390625],
    [0.019611980766057968, 0.19468696415424347],
    [-0.0024558373261243105, 0.1976243555545807],
    [-0.019747938960790634, 0.2005617469549179],
    [-0.03185298293828964, 0.20349913835525513],
    [-0.038482993841171265, 0.20643652975559235],
    [-0.03948025405406952, 0.20937392115592957],
    ]),
    "Sensor Fault": np.array([
    [0.33712178468704224, 0.3686292767524719],
    [0.3072371780872345, 0.3558255732059479],
    [0.28417304158210754, 0.3338000476360321],
    [0.2701110541820526, 0.304636150598526],
    [0.2663814425468445, 0.27109256386756897],
    [0.2733369767665863, 0.23702487349510193],
    [0.29031968116760254, 0.20667295157909393],
    [0.3157230615615845, 0.18291756510734558],
    [0.3471442461013794, 0.16800574958324432],
    [0.3816111087799072, 0.1633480340242386],
    ]),
}
