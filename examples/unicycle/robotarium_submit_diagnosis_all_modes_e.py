...
ONE unicycle config (multistep_unrefined/config_idx=57), run back-to-back in one Robotarium session.
...
Config selection: method=multistep_unrefined, config_idx=57 from
...
# "Regenerating the embedded constants". method=multistep_unrefined, config_idx=57.
# ══════════════════════════════════════════════════════════════════════════
U_OPT = np.array([
...
X0_WIDTH = 0.019999999552965164   # half-width car_separating_input.py's icentpert()
